...
public class ForgetPassword extends JFrame implements ActionListener{
	...
	ForgetPassword() {
		...
		ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("forgotpassword.jpeg"));
	...
	public void actionPerformed(ActionEvent ae) {
		if(ae.getSource() == search) {
			...
			try {
				String quer = "select * from account where answer = '"+tfanswer.getText()+"' AND username = '"+tfusername.getText()+"'";
				Connect c = new Connect();
				ResultSet rs = c.s.executeQuery(quer);
